...
public class EnterpriseFixture {
    ...
    public static final Enterprise enterprise1 = new Enterprise("기업1", BusinessCode.CODE_11111, "홈페이지주소1", "주소1");
    public static final Enterprise enterprise2 = new Enterprise("기업2", BusinessCode.CODE_11102, "홈페이지주소2", "주소2");
    public static final Enterprise enterprise3 = new Enterprise("기업3", BusinessCode.CODE_11112, "홈페이지주소3", "주소3");
