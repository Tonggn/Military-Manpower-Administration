...
public class EnterpriseFixture {
    ...
    public static final Enterprise ENTERPRISE_1 = new Enterprise("기업1", BusinessType.TYPE_11111, "홈페이지주소1", "주소1");
    public static final Enterprise ENTERPRISE_2 = new Enterprise("기업2", BusinessType.TYPE_11102, "홈페이지주소2", "주소2");
    public static final Enterprise ENTERPRISE_3 = new Enterprise("기업3", BusinessType.TYPE_11112, "홈페이지주소3", "주소3");
